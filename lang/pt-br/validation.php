...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de idioma contêm as mensagens de erro padrão usadas pela classe de validação.
    | Algumas dessas regras têm várias versões, como as regras de tamanho. Sinta-se à vontade para personalizar cada uma dessas mensagens aqui.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'O :attribute fornecido apareceu em uma violação de dados. Escolha um :attribute diferente.',
    ],
    ...
    | convenção "atributo.regra" para nomear as linhas. Isso torna rápido especificar uma linha de idioma específica para uma regra de atributo dada.
    |
    */
    ...
    | por algo mais amigável ao leitor, como "Endereço de e-mail" em vez de "email". Isso ajuda a tornar nossa mensagem mais expressiva.
    |
    */
